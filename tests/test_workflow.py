...
from mif.workflow import ActionRegistry, WorkflowItem
...
class TestBuiltInActions:
    ...
    def test_action_print(self, capsys):
        ...
        from mif.workflow import action_print
    ...
    def test_action_open_url(self, mock_open):
        ...
        from mif.workflow import action_open_url
    ...
    def test_action_run(self, mock_run):
        ...
        from mif.workflow import action_run
    ...
    def test_action_open_file(self, mock_open):
        ...
        from mif.workflow import action_open_file
...
class TestExtendedActions:
    ...
    def test_action_notify_macos(self, mock_platform, mock_run):
        ...
        from mif.workflow import action_notify
    ...
    def test_action_set_env(self):
        ...
        from mif.workflow import action_set_env
        import os
    ...
    def test_action_change_dir(self, mock_is_dir, mock_exists, mock_chdir):
        ...
        from mif.workflow import action_change_dir
    ...
    def test_action_write_file(self, mock_mkdir):
        ...
        from mif.workflow import action_write_file
        import tempfile
        import os
    ...
    def test_action_read_file(self, mock_print):
        ...
        from mif.workflow import action_read_file
        import tempfile
        import os
